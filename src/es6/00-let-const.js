...
const fruits = () => {
    if(true) {
        ...
        let fruit2 = 'Kiwi'; //block scope solo funcionan dentro de su mismo bloque no en global
        const fruit3 = 'Banana'; //block scope solo funcionan dentro de su mismo bloque no en global
    }
    console.log(fruit1);
    console.log(fruit2);
    console.log(fruit3);
